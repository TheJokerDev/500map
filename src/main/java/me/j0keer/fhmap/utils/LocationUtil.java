...
public class LocationUtil {
    ...
    public static Location locationConverter(World world, BlockVector3 blockVector3) {
        return new Location(Bukkit.getWorld(world.getName()), blockVector3.getX(), blockVector3.getY(), blockVector3.getZ());
    }
